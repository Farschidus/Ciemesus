            ...
            <asp:UpdatePanel ID="uplContact" runat="server">
                <ContentTemplate>
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><%= Farschidus.Translator.AppTranslate["ascx.contact.lable.phone"]%></label>
                            <div class="col-sm-10">
                                <asp:Label ID="lblPhone" runat="server"></asp:Label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><%= Farschidus.Translator.AppTranslate["ascx.contact.lable.fax"]%></label>
                            <div class="col-sm-10">
                                <asp:Label ID="lblFax" runat="server"></asp:Label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><%= Farschidus.Translator.AppTranslate["ascx.contact.lable.email"]%></label>
                            <div class="col-sm-10">
                                <asp:Label ID="lblEmail" runat="server"></asp:Label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><%= Farschidus.Translator.AppTranslate["ascx.contact.lable.address"]%></label>
                            <div class="col-sm-10">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><%= Farschidus.Translator.AppTranslate["ascx.contact.lable.department"]%></label>
                            <div class="col-sm-10">
