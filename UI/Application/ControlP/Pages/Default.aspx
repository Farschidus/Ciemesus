<%@ Page Language="C#" MasterPageFile="~/Application/Masters/CP.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="Default.aspx.cs" Inherits="PSM_Pages_Default" %>
...
<asp:Content ID="SearchContent" ContentPlaceHolderID="cphSearch" runat="Server">
    <div id="Search">
        <table width="640px" style="display: inline-block">
            <tr>
                <td class="right ltr">
                    <%=Farschidus.Translator.AppTranslate["pagesManaging.default.search.title"]%>
                </td>
                <td class="left languageLtr" colspan="4">
                    <asp:TextBox ID="txtTitleSearch" runat="server" Width="600px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="right rtl">
                    <%=Farschidus.Translator.AppTranslate["pagesManaging.default.search.alias"]%>
                </td>
                <td class="left languageLtr">
                    <asp:TextBox ID="txtAliasSearch" runat="server" Width="515px"></asp:TextBox>
                </td>
                <td class="right top">
                    <asp:LinkButton ID="btnSearch" runat="server" OnClick="btnSearch_Click" CssClass="greenButton search">
                        ...
                        <ContentTemplate>
                            <Farschidus:GridView ID="grvList" runat="server" ViewStateMode="Enabled" AutoGenerateColumns="false"
                                ...
                                <Columns>                                    
                                    ...
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            <%=Farschidus.Translator.AppTranslate["pagesManaging.default.grid.subjectName"]%>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <%# Eval("Title") %>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            <%=Farschidus.Translator.AppTranslate["pagesManaging.default.grid.bannerType"]%>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="edit">
                                        <HeaderTemplate>
                                            <%=Farschidus.Translator.AppTranslate["pagesManaging.default.grid.edit"]%>
                                        </HeaderTemplate>
                                        <ItemTemplate>
            ...
            <ContentTemplate>
                <table width="850px" style="display: inline-block">
                    ...
                    <tr>
                        ...
                        <td class="left ltr">
                            <%= Global.MethodsAndProps.mGetHtmlLink(pIDSubject, BLL.BusinessEntity.SubjectTypes.Enum.page) %>
                        </td>
                    </tr>
                    <tr>
                        <td class="right ltr">
                            <%=Farschidus.Translator.AppTranslate["pagesManaging.default.addEdit.isActive"]%>
                        </td>
                        <td class="left ltr">
                    ...
                    <tr>
                        <td class="right ltr">
                            <%=Farschidus.Translator.AppTranslate["pagesManaging.default.addEdit.iDParent"]%>
                        </td>
                        <td class="left CpLtr">
                            <asp:DropDownList ID="ddlParent" runat="server" AppendDataBoundItems="true" Width="780px">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <td class="right ltr">
                            <%=Farschidus.Translator.AppTranslate["pagesManaging.default.addEdit.alias"]%>
                        </td>
                        <td class="left languageLtr">
                    ...
                    <tr>
                        <td class="right ltr">
                            <%=Farschidus.Translator.AppTranslate["pagesManaging.default.addEdit.title"]%>
                        </td>
                        <td class="left languageLtr">
                    ...
                    <tr>
                        <td class="right ltr top">
                            <%=Farschidus.Translator.AppTranslate["pagesManaging.default.addEdit.body"]%>
                        </td>
                        <td class="left rtl">
