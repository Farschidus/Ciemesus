<%@ Page Language="C#" MasterPageFile="~/Application/Masters/CP.master" AutoEventWireup="true"
    ValidateRequest="false" CodeFile="Default.aspx.cs" Inherits="PSM_Forms_Default" %>
...
<asp:Content ID="SearchContent" ContentPlaceHolderID="cphSearch" runat="Server">
    <div id="Search">
        <table width="350px" style="display: inline-block">
            <tr>
                <td class="right ltr">
                    <%=Farschidus.Translator.AppTranslate["form.default.search.title"]%>
                </td>
                        ...
                        <ContentTemplate>
                            <Farschidus:GridView ID="grvList" runat="server" ViewStateMode="Enabled" AutoGenerateColumns="false"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            <%=Farschidus.Translator.AppTranslate["form.default.grid.subjectName"]%>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <%# Eval("Title") %>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            <%=Farschidus.Translator.AppTranslate["form.default.grid.bannerType"]%>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <%# mGetGalleryTypeName(Eval("BannerType").ToString()) %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="report">
                                        <HeaderTemplate>
                                            <%=Farschidus.Translator.AppTranslate["form.default.grid.report"]%>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <a href='Report.aspx?<%= Global.Constants.QUERYSTRING_SUBJECT_ID %>=<%# Eval("IDSubject").ToString() %>' target="_blank" class="gridReport">Report</a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="edit">
                                        <HeaderTemplate>
                                            <%=Farschidus.Translator.AppTranslate["form.default.grid.edit"]%>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="delete">
                                        <HeaderTemplate>
                                            <%=Farschidus.Translator.AppTranslate["form.default.grid.delete"]%>
                                        </HeaderTemplate>
                                        <ItemTemplate>
        ...
        <asp:UpdatePanel ID="uplAddEdit" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
            <ContentTemplate>
                <table width="850px" style="display: inline-block">
                    ...
                    <tr>
                        <td class="right ltr">
                            <%=Farschidus.Translator.AppTranslate["form.default.addEdit.formID"]%>
                        </td>
                        <td class="left ltr">
                    ...
                    <tr>
                        ...
                        <td class="left ltr">
                            <%= Global.MethodsAndProps.mGetHtmlLink(pIDSubject, BLL.BusinessEntity.SubjectTypes.Enum.form) %>
                        </td>
                    </tr>
                    <tr>
                        <td class="right ltr">
                            <%=Farschidus.Translator.AppTranslate["form.default.addEdit.alias"]%>
                        </td>
                        <td class="left languageLtr">
                    ...
                    <tr>
                        <td class="right ltr">
                            <%=Farschidus.Translator.AppTranslate["form.default.addEdit.title"]%>
                        </td>
                        <td class="left languageLtr">
                    ...
                    <tr>
                        <td class="right ltr top">
                            <%=Farschidus.Translator.AppTranslate["form.default.addEdit.body"]%>
                        </td>
                        <td class="left ltr">
