<%@ Page Language="C#" MasterPageFile="~/Application/Masters/Popup.master" AutoEventWireup="true" CodeFile="Popup.aspx.cs" Inherits="ControlP_Thumbnail_Popup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <div id="Repository">
        <span class="title"><%= Farschidus.Translator.AppTranslate["thumbnail.popup.repositoryFiles"]%></span>
            ...
            <ContentTemplate>
                <Farschidus:GridView ID="grvList" runat="server" ViewStateMode="Enabled" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <HeaderTemplate>
                                <%=Farschidus.Translator.AppTranslate["thumbnail.popup.grid.fileName"]%>
                            </HeaderTemplate>
                            <ItemTemplate>
                                <%# Eval("FileName") %>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField>
                            <HeaderTemplate>
                                <%=Farschidus.Translator.AppTranslate["thumbnail.popup.grid.fileExtention"]%>
                            </HeaderTemplate>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField>
                            <HeaderTemplate>
                                <%=Farschidus.Translator.AppTranslate["thumbnail.popup.grid.imageLink"]%>
                            </HeaderTemplate>
                            <ItemTemplate>
        ...
        <asp:UpdatePanel ID="uplAddRemove" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
            <ContentTemplate>
                <asp:LinkButton ID="btnAddToPage" runat="server" OnClick="btnAddToPage_Click" CssClass="blueButton">
                    <%= Farschidus.Translator.AppTranslate["thumbnail.popup.button.addToPage"]%>
                </asp:LinkButton>
                <br />
                <asp:LinkButton ID="btnRemoveFromPage" runat="server" OnClick="btnRemoveFromPage_Click" CssClass="redButton">
                    <%= Farschidus.Translator.AppTranslate["thumbnail.popup.button.removeFromPage"]%>
                </asp:LinkButton>
            </ContentTemplate>
        </asp:UpdatePanel>
    </div>
    <div id="Files">
        <span class="title"><%= Farschidus.Translator.AppTranslate["thumbnail.popup.addedFiles"]%></span>
