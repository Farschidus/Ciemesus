...
{
	/// <summary>
	/// This class is dynamcially created when you add a WhereParameter to your BusiinessEntity's DynamicQuery (See the CoreEntity.Query Property).
	/// </summary>
	/// <remarks>
	...
	public class WhereParameter
	{
		...
		/// <summary>
		/// The column in the CoreEntity that this WhereParameter is going to query against. 
		/// </summary>
