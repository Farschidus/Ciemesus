...
namespace DAL.GlobalCore
{
    /// <summary>
    /// CoreEntity provides the bulk of the logic for dOOdads. Your generated class will ultimately inherit from this class.
    /// See our website at http://www.mygenerationsoftware.com/dOOdads/dOOdads.aspx for more information.
    /// </summary>
    [Serializable]
    abstract public class CoreEntity : EventArgs
    {

        abstract internal DynamicQuery CreateDynamicQuery(CoreEntity entity);
        ...
        //--------------------- %Check% -------------------------------//
        // These are newly added to doodads by Farschidus 
        public virtual bool LoadAll()
        {
            return false; ;
        }
        public virtual bool LoadByPrimaryKey(object primaryKey)
        {
            return false;
        }
        public virtual bool LoadByPrimaryKey(object primaryKey1, object primaryKey2)
        {
            return false;
        }
        public virtual bool LoadByPrimaryKey(object primaryKey1, object primaryKey2, object primaryKey3)
        {
            return false;
        }
        //-------------------------------------------------------------//
        ...
        /// Query.Load to bring back extra columns in your CoreEntity from a View. You will however have to access those extra 
        ...
        /// <summary>
        /// Called by CoreEntity but implemented in your generated class by MyGeneration during template generation.
        /// </summary>
        ...
        /// <code>
        /// 
        /// CoreEntity.DefaultConnectionStringConfig = "SiteSqlServer"
        /// 
        /// &lt;configuration&gt;
        ///   &lt;appSettings&gt;
        ...
        static public string DefaultConnectionStringConfig
        {
            get
            {
                return CoreEntity._defaultConfig;
            }
            set
            {
                CoreEntity._defaultConfig = value;
            }
        }

        /// <summary>
        /// After loading your CoreEntity you can filter (temporary hide) rows. To disable the filter set this property to String.empty.
        ...
        /// <summary>
        /// After loading your CoreEntity you can sort the rows. To disable the sort set this property to String.empty.
        ...
        /// <summary>
        /// After loading your CoreEntity you can add custom columns, this is typically done to create a calculated column, however, it can
        ...
        /// <summary>
        /// You can use this to determine the rowstate of a given row in your CoreEntity, examples are Added, Deleted, Modified.
        /// </summary>
        /// <returns>The row state of the current row in your CoreEntity</returns>
        ...
        /// <summary>
        /// The number of rows in your CoreEntity or Zero if none.
        /// </summary>
        public int RowCount
        {
            get
        ...
        /// <summary>
        /// After loading your CoreEntity it is automatically position on the first row. Thus, you need to call MoveTo as shown in the following 
        /// example.
        /// </summary>
        /// <example>
        /// VB.NET
        ...
        ///    Dim lastName As String
        ///
        ///    ' chnges the cirrentRecord index to the value supported
        ///    
        ///        emps.MoveTo(2);
        ///  lastName = emps.LastName;
        ///
        ...
        /// </example>
        /// 
        // %Check% // This is added to change the currentRow to index value // simillar to _rowData= _dataable[index];
        public bool MoveTo(long index)
        {
            ...
            if (_dataTable != null)
            {
                if (index < _dataTable.DefaultView.Count)
                {
                    for (long i = 0; i < index && (moved = MoveNext()); i++) ;

                    //The currentRecord succesfuly set to the index
                }
            }
            return moved;
        }
        ...
        /// <summary>
        /// After loading your CoreEntity it is automatically position on the first row. Thus, you need to call MoveNext as shown in the following 
        /// example.
        /// </summary>
        /// <example>
        /// VB.NET
        ...
        /// <summary>
        /// This is the ADO.NET DataTable, it holds the data for your CoreEntity. It is protected so your derived class can have access
        /// to it but the consumers of your CoreEntity cannot. Exposing this publically is not a good idea as your data would be able
        ...
        /// <summary>
        /// This is the ADO.NET DataRow, it holds the data for your CoreEntity. It is protected so your derived class can have access
        /// to it but the consumers of your CoreEntity cannot. Exposing this publically is not a good idea as your data would be able
        /// to be modified without going through you business logic.
        /// </summary>
        ...
        /// <summary>
        /// Use LoadFromSql to load you CoreEntity from a custom stored procedure. The generated method in your 
        /// CoreEntity called 'LoadByPrimaryKey' uses this method.
        /// </summary>
        ...
        /// <summary>
        /// Use LoadFromSqlNoExec to execute a stored procedure, this method does not load data into your CoreEntity.
        /// </summary>
        ...
        /// <summary>
        /// Use LoadFromSqlScalar to execute a stored procedure, this method does not load data into your CoreEntity.
        /// </summary>
        /// <param name="sp">The name of the stored procedure</param>
        ...
        /// <summary>
        /// LoadFromSqlReader does not load data into your CoreEntity
        /// </summary>
        /// <param name="sp">This must be a stored procedure</param>
        ...
        /// <summary>
        /// AddNew is how you add a new record to your CoreEntity, when saved this row will be an INSERT. 
        ...
        /// </summary>
        virtual public void MarkAsDeleted(bool isVirtual)
        {
            if (_dataRow != null)
            {
                // %Check% //
                // This is added to doodads to handel virtual delete
                if (isVirtual)
                {
                    if (_dataRow["IsDeleted"] != null)
                    {
                        _dataRow["IsDeleted"] = true;
                    }
                }
                else
                {
        ...
        {
            // %Check% //
            // we should also remove the virtualy deleted row  from _dataTable 
            if (this.RowCount > 0)
            {
                if (_dataRow.Table.Columns.Contains("fIsDeleted"))
                    if (!_dataRow.IsNull("fIsDeleted"))
                        if ((bool)_dataRow["fIsDeleted"] == true)
                            _dataRow.Delete();
        ...
        /// <summary>
        /// After calling this method your CoreEntity will contain only rows that have been
        ...
        /// <summary>
        /// After calling this method your CoreEntity will contain only those row that match the value
        ...
        /// <summary>
        /// This property returns the DynamicQuery object which will allow you to build complex queries using your CoreEntity.
        /// </summary>
        ...
        internal string RawConnectionString
        {
            get
            {
                ...
                if (_raw != "")
                    ...
                    connStr = ConfigurationManager.ConnectionStrings[_config].ConnectionString;
        ...
        /// <param name="columnName">One of the named for your ColumnNames class</param>
        /// <returns>The value</returns>
        protected Int16 Getint16(string columnName)
        {
            return (Int16)_dataRow[columnName];
        }
        ...
        /// <param name="columnName">One of the named for your ColumnNames class</param>
        /// <param name="data">The Value</param>
        protected void Setint16(string columnName, Int16 data)
        {
            _dataRow[columnName] = data;
        }
        /// <summary>
        ...
        {
            // %Newly Added
            return Convert.ToSingle(_dataRow[columnName]);
        }
        ...
        /// <param name="columnName">One of the named for your ColumnNames class</param>
        /// <returns>The value</returns>
        protected string Getint16AsString(string columnName)
        {
            return _dataRow[columnName].ToString();
        }
        ...
        /// <param name="data">The Value</param>
        /// <returns>The Strong Type</returns>
        protected Int16 Setint16AsString(string columnName, string data)
        {
        ...
        internal string _config = CoreEntity._defaultConfig;
