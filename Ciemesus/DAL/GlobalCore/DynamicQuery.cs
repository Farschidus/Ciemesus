...
namespace DAL.GlobalCore
{
	...
	abstract public class DynamicQuery
	{
		...
		/// <summary>
		/// You never need to call this, just access your CoreEntity.Query property.
		/// </summary>
		/// <param name="entity">Passed in via the CoreEntity</param>
		public DynamicQuery(CoreEntity entity)
		{
			this._entity = entity;
		}
		...
		/// <summary>
		/// Execute the Query and loads your CoreEntity. The default conjuction between the WHERE parameters is "AND"
		/// </summary>
		...
		/// <summary>
		/// Executes the Query, however, your CoreEntity will not be loaded with the data from the query, instead, a DataReader is returned that will allow you 
		...
		///
        /// 	' Sort
        /// 	prds.Query.AddOrderBy(prds.ColumnNames.ProductName, GlobalCore.WhereParameter.Dir.ASC)
		/// 	
        /// 	' Load it
        /// 	prds.Query.Load()
		/// 	
		...
		///
		/// 	// Sort
		/// 	prds.Query.AddOrderBy(Products.ColumnNames.ProductName, GlobalCore.WhereParameter.Dir.ASC);
		/// 	
		/// 	// Load it
		/// 	prds.Query.Load();
		///
