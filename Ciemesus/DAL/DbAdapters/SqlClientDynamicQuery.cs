...
namespace DAL.DbAdapters
{
	...
	{
		public SqlClientDynamicQuery(CoreEntity entity)
			: base(entity)
		{
			
		}

		public override void AddOrderBy(string column, GlobalCore.WhereParameter.Dir direction)
		{
			base.AddOrderBy ("[" + column + "]", direction);
		}

		public override void AddOrderBy(DynamicQuery countAll, GlobalCore.WhereParameter.Dir direction)
		{
		...
		public override void AddOrderBy(AggregateParameter aggregate, GlobalCore.WhereParameter.Dir direction)
		{
