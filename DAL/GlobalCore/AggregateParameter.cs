...
{
	/// <summary>
	/// This class is dynamcially created when you add an AggregateParameter to your CoreEntity's DynamicQuery (See the CoreEntity.Query Property).
	/// </summary>
	/// <remarks>
	...
	public class AggregateParameter
	{
		...
		/// <summary>
		/// The column in the CoreEntity that this AggregateParameter is going to query against. 
		/// </summary>
